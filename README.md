To Run: cd into the app root directory, install npm, then use 'npm start' to run the application. Full official details of npm and ReactJS can be found in ReactDoc.dm .
